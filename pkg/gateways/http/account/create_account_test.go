...
func TestHandler_CreateAccount(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			enc:          &mocks.StubHash{},
			decoder:      tests.ErrorMessageDecoder{},
			body:         requestBody{Name: "Pedro", Secret: "12345678"},
		...
		},
		{
			...
			enc:          &mocks.StubHash{},
			decoder:      tests.ErrorMessageDecoder{},
			body:         requestBody{Name: "Pedro", CPF: tests.TestCPF1.String()},
		...
		},
		{
			...
			enc:          &mocks.StubHash{},
			decoder:      tests.ErrorMessageDecoder{},
			body:         requestBody{Name: "Pedro", CPF: "123.456.789-00", Secret: "12345678"},
		...
		},
		{
			...
			enc:          &mocks.StubHash{},
			decoder:      tests.ErrorMessageDecoder{},
			body:         requestBody{Name: "Pedro", CPF: tests.TestCPF1.String(), Secret: "12345678"},
		...
		},
		{
			...
			repo: &mocks.StubAccountRepository{
				Accounts: []entities.Account{entities.NewAccount(
					"Junior", tests.TestCPF1, vos.NewSecret("aS1234Dz"),
				)},
			},
			enc:          &mocks.StubHash{},
			decoder:      tests.ErrorMessageDecoder{},
			body:         requestBody{Name: "Pedro", CPF: tests.TestCPF1.String(), Secret: "As1234dZ"},
		...
		},
		{
			...
			body:         requestBody{Name: "Pedro", CPF: tests.TestCPF1.String(), Secret: "As1234dZ"},
			expectedBody: createdAccountResponse{Name: "Pedro", CPF: tests.TestCPF1.String(), Balance: 0},
